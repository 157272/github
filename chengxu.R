...
seirplot <- ggplot2::ggplot(data=result)+
  ggplot2::geom_line(ggplot2::aes(x=time, y=S,col="S"), lwd=1) +
  ggplot2::geom_line(ggplot2::aes(x=time, y=I,col="I"), lwd=1) +
  ggplot2::geom_line(ggplot2::aes(x=time, y=R,col="R"), lwd=1) +
  ggplot2::geom_line(ggplot2::aes(x=time, y=E,col="E"), lwd=1) +
